...
public class BoardViewActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// SET ONLONGCLICK QUAND ON AJOUTE CARTE // Opponent Context c =
		...
		iv.setOnClickListener(new CardViewOpponentOnClickListener(em));
		iv.setOnLongClickListener(new CardViewOnLongClickListener(getApplicationContext()));
		...
		iv.setOnClickListener(new CardViewPlayerOnClickListener(board));
	...
	public void onMessage(Event e) {
		...
		if (e instanceof PlaceCardEvent) {
			...
			CardView cv = (CardView) findViewById(((PlaceCardEvent) e)
					.getIdPosition());
			cv.removeAllViews();
