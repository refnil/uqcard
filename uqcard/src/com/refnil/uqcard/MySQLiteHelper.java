...
public class MySQLiteHelper extends SQLiteOpenHelper {
	...
	static final String CARDS_TABLE_CREATE = "create table " + TABLE_CARDS
			+ "(" + CARDS_ID + " integer primary key autoincrement, "
			+ CARDS_NAME + " text not null, " + CARDS_DESCRIPTION
			+ " text not null, " + CARDS_COST + " integer not null, "
			+ CARDS_FLAVOR + " text not null, " + CARDS_IMAGE
			+ " blob not null " + ");";

	static final String CREATURECARDS_TABLE_CREATE = "create table "
			+ TABLE_CREATURECARDS + "(" + CREATURECARDS_IDCARD
			+ " integer not null, " + CREATURECARDS_ATTACK
			+ " integer not null, " + CREATURECARDS_DEFENSE
			+ " integer not null, " + CREATURECARDS_HEALTH
			+ " integer not null, " + " FOREING KEY(" + CREATURECARDS_IDCARD
			+ ") REFENRENCES " + TABLE_CARDS + "(" + CARDS_ID + ")" + ");";
